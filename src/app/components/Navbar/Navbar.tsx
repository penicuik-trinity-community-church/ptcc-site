  ...
  return (
    <nav className="sticky top-0 w-full bg-white shadow-lg z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        {/* navigation links */}
        <div
          className={`flex-col md:flex-row md:flex md:space-x-6 absolute md:static top-full left-0 w-full md:w-auto bg-white md:bg-transparent px-4 md:px-0 transition-all duration-300 ease-in-out ${isOpen ? 'flex' : 'hidden'
            }`}
        >
